...
public class CourseAdapterExpandable extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            if (convertView == null) {
                LayoutInflater infalInflater = (LayoutInflater) this._context
                        .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                convertView = infalInflater.inflate(R.layout.crono_list_group, null);
            }
            ...
            if (!headerTitleString.equals("")) {
                ...
                lblListHeader.setTextColor(convertView.getResources().getColor(R.color.colorNavText));
                lblListHeader.setBackgroundColor(convertView.getResources().getColor(R.color.colorPrimary));
            } else {
